...
if(isset($_POST['submit'])){
    ...
    $email_serch="select * from session where email='$email'";
...
<div class="container">
	...
	<form class="registration-form" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="post">
		<label>
        ...
        <br>
        <!-- <p class="text-center"> Forget password Now? <a href="recover_email.php">click Here</a></p> -->

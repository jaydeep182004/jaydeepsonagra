...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="http://localhost/phpmyadmin/index.php?route=/sql&pos=0&db=php-data&table=product">database</a>
                    </li>
                    <li class="nav-item">
    ...
    state:<select name="state" >
            ...
            <div class="error"> <?php if(isset($_GET['stateerr'])) echo $_GET["stateerr"];?></div><br><br>
    ...
    category:<select name="category">
        ...
        <?php while ($row=mysqli_fetch_assoc($query1)) {
            ...
            if (isset($_GET['id']) && $res['mobile'] == $row['id']) {
                echo " selected='selected'";
            }

            echo ">".$row['MOBILE']."</option>";
        }?>
        </select>
        <div class="error"> <?php if(isset($_GET['caterr'])) echo $_GET["caterr"];?></div>
            ...
            <input type="hidden" name="id1" value="<?php if (isset($id)) {
                echo $id;
            }
